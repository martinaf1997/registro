...
# CONFIG
# ---------------------------
SHEET_NAME = "Pomeriggio - Iscrizione corso di italiano per adulti - Associazione Paroikia odv anno 2026-2027 (Risposte)"
WORKSHEET_NAME = "Risposte del modulo 1"
...
def connect_to_gsheet():
    ...
    sh = gc.open("Pomeriggio - Iscrizione corso di italiano per adulti - Associazione Paroikia odv anno 2026-2027 (Risposte)")
    return sh.worksheet("Risposte del modulo 1")
